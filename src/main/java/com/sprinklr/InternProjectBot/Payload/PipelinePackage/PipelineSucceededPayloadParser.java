...
public class PipelineSucceededPayloadParser extends PipelinePayloadParser{

    public PipelineSucceededPayloadParser(GitLabAPI gitLabAPI){
        super(gitLabAPI);
    }
    ...
    public List<Message> getMessagesToBeSentInHtml() {
        ...
        messageBody.setMessageTypeID(MessageTypeID.PIPELINE_SUCCESS);
